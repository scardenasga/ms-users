...
public class CorreoContrasena implements StrategyEmail{
private final String destinatario;
    private final String codigo;
    

    public CorreoContrasena (String destinatario, String codigo){
    ...
    public void enviarCorreo() {
       try {
            ...
            String contenido = new String(Files.readAllBytes(Paths.get("src/main/webapp/contraseña.xhtml")));
